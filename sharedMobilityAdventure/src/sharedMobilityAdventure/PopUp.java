...
public class PopUp {
    ...
    //list of carbon emission related facts to choose from at random
    ...
    public void initialPopUp(String message) {
        JOptionPane.showMessageDialog(null, message, "Initial Popup", JOptionPane.INFORMATION_MESSAGE);
    }
    
    public void informationPopUp() {
        // Generate a random index to pick a random message from the list
        int randomIndex = new Random().nextInt(informationOptions.length);
        
        // Show a JOptionPane with the randomly picked message
        JOptionPane.showMessageDialog(null,
                informationOptions[randomIndex],
                "Carbon Fact! Did You Know?",
